...
function ChangeKeyRepeat {
    $RegistryPath = "HKCU:/Control Panel/Keyboard"
    $null = New-ItemProperty -Path $RegistryPath -Name "KeyboardDelay" -PropertyType String -Value "0" -Force
    $null = New-ItemProperty -Path $RegistryPath -Name "KeyboardSpeed" -PropertyType String -Value "31" -Force
}
